...
const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    title: "제2조 (서비스 내용)",
    body:
      "앱은 사용자의 현재 위치·이동수단·시간 조건을 바탕으로 랜덤 여행 코스(목적지, 식사, 디저트, 즐길거리)를 제안하는 서비스를 제공합니다. 추첨은 하루 5회 무료로 제공되며, 모두 소진 시 광고 한 편 시청으로 3회를 추가 충전할 수 있습니다. 무료 횟수는 매일 자정에 초기화됩니다. 첫차·막차 등 대중교통 운행 시간표는 검증 대상에 포함되지 않으므로 이용자가 직접 확인해야 합니다.",
  },
  {
    id: "article-3",
